...
public class DefineConstants {
	...
	//Manager_SignIn
	public static final String Individual_signIn = TestData_Folder + "//" + "Indivisual_SignIn.json";
	...
	//public static final String Indivisual_SignIn= TestData_Folder + "//" + "Indivisual_SignIn.json";
}